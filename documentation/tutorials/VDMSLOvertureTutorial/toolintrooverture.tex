...
on the book's web site~\url{http://overturetool.org/publications/books/ms2/}. Throughout this guide
...
by \emph{Overture} $\rightarrow$ \emph{Overture Examples} $\rightarrow$ \emph{VDM-SL}.  Initially it is
...
indicate that these proof obligations are trivially satisfied. It is
also possible to get rid of such proo2.3.0f obligations in the list by
