...
\item[Syntax:]
  ...
  \Rule{is expression}{
    \Lop{is\_}, (\Ruleref{name} \dsep \Ruleref{basic type}), \Lit{(}, \Ruleref{expression}, \Lit{)} 
    }
...
\Rule{mutex predicate}{
       \Lop{mutex}, \Lit{(}, (\Lop{all} \dsep \Ruleref{name list}, \Lit{)}}
...
\Ruledef{is expression}{
  \Lit{\keyw{is}\_},\nmk (\Ruleref{name} \dsep \Ruleref{basic type}), \Lit{(}, \Ruleref{expression}, \Lit{)}
}
\ntext{no delimiter is allowed}
