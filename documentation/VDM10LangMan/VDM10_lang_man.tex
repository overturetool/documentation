...
As before the s in the measure clause is the argument variable in the definition of {\tt dupe}. The measure function reduces because the semantics of concatenation patterns ensure that the sequence s is split into {\tt t} and {\tt u} such that {\tt t} and {\tt u} contain at least one element each.
...
\Ruledef{extended explicit function definition}{
  ...
  \OptPt{\Lop{pre}, \Ruleref{expression}}, \lfeed
  \OptPt{\Lop{post}, \Ruleref{expression}},
  \OptPt{\Lop{measure}, \Ruleref{expression}}
}
%#endif VDMSL
