...
April & 2016 & 7 & 2.3.4 & review inputs from Paul Chisholm \\ \hline
\end{tabular}
...
In VDM-SL the presence of such pre- and post-conditions the VDM interpreters will alo
...
%    state signature
  ...
  \Rule{export functions signature}{
    ...
    \SeqPt{\Lit{;}, \Ruleref{function signature}}
    }

  \Rule{function signature}{
    \Ruleref{name list}, \OptPt{\Ruleref{type variable list}}, \lfeed
    \Ruleref{function type}, \OptPt{\Lit{;}}
    }
...
such that
  ...
  (with its structure) any
  importing module may only make use of this structure if the exporting module has exported its structure using the \keyw{struct} keyword. Records imported in this way will make reference to its defining module, e.g., \keyw{mk\_}{\tt ExportingMod`RecordName}. In
  case such a type is a composite type which is renamed upon import this has
  the consequence that the tag is renamed as well, i.e., if such a type is renamed to {\tt ImportedRecName} it will be referred to as \keyw{mk\_}{\tt EImportedRecName}.
