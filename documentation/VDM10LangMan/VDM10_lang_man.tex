...
\item[Semantics:] Operations in VDM are per default synchronous but if
  ...
  it means that it is executed atomically and it is allowed to be called in a functional context. Such operations cannot have any side effect and thus they can also not be used in synchronisation constraints.
