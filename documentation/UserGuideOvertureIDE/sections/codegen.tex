...
The generator will emit a \texttt{main.c} file containing an empty \texttt{main()} function.
%
Moreover, the file contains helper functions for system-wide initialization and tear-down of model \texttt{values} and static fields.
%
...
\input{sections/codegen-translation-subsection}
%%% Local Variables:
%%% mode: latex
