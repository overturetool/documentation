...
Environment (IDE) version 2.1.? for
...
For a subset of VDM models it is possible to automatically produce code either in Java or C++. \index{code generation}
This kind of feature is also available in VDMTools \cite{Java2VDMMan,CGMan,CGManPP}. 

\section{Configuration of the Code Generator}


\section{Use of the Code Generator}


\section{Limitations of the Code Generator}


\section{Incorporation of Standard Libraries}
