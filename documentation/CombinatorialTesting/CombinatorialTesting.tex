...
that the ACME implementation was at fault. However, since at any one time there
are very many ACME parcels in circulation, and many barcode scanners would have
had to change too, the decision was taken to reproduce the invalid algorithm in
