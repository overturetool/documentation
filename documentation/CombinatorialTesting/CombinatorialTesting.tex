...
VDMTools\footnote{https://github.com/vdmtools/vdmtools} includes traces suport through interpreters.
The interpreter window that provides a REPL interface accepts the \texttt{traces} command to run a trace althrough the tool does not have a GUI dedicated to traces.
