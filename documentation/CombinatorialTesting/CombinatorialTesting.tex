...
\normalsize
  ...
  a set, rather than k-permutations. This is similar, but with a \texttt{be st}
  discriminator that selects one unique combination from the possible orderings
  (here, \texttt{c1 < c2 and c2 < c3}):
\small
\begin{lstlisting}
