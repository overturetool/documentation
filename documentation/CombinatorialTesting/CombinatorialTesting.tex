...
Although the Overture IDE is convenient for developing combinatorial tests, to
push the tool to the limit of what is possible it is better to use the command
line. This allows more memory to be allocated to the process running the traces
without the IDE occupying space itself.
